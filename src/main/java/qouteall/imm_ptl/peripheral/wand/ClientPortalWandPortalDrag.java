...
//    );
    ...
    public static void tick() {
        ...
        if (isDragging()) {
            if (player.getItemInHand(InteractionHand.MAIN_HAND).getItem() != PeripheralModEntry.PORTAL_WAND.get() &&
                player.getItemInHand(InteractionHand.OFF_HAND).getItem() != PeripheralModEntry.PORTAL_WAND.get()
            ) {
